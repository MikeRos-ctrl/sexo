...
<body>
    ...
    <h2 class="display-4 text-center" style="margin-bottom: 50px;letter-spacing: 39px;color: rgb(0,0,0);margin-top: -145px;padding-top: 174px;padding-bottom: 71px;background: linear-gradient(var(--bs-green), white), var(--bs-pink);">DECOUR</h2>
    ...
    data-reflow-category="392457629" 
    data-aos="fade-up" 
    ...
    <div class="text-center" data-aos="fade-up" data-aos-duration="450" data-aos-delay="650">
        ...
        <a class="btn btn-outline-primary border rounded-0" role="button" data-bss-hover-animate="pulse" style="margin-right: 62px;background: linear-gradient(var(--bs-blue), white), var(--bs-info);" href="fences.php">FENCES</a>
        
        <a class="btn btn-outline-primary border rounded-0" role="button" data-bss-hover-animate="pulse" style="margin-right: 62px;background: linear-gradient(#fed136, white), var(--bs-green);" href="lights.php">LIGHTS</a>
